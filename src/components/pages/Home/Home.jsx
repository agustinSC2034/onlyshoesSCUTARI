    ...
    return (
      ...
      <div class="textoMenuContainer">
        ...
        <div class="enviosContainer">
            <h3>Envios y devoluciones <span>GRATIS!</span></h3>
        </div>
            ...
            <div className="containerPagos">
                <div className="containerPagos2">
                    <div className="col-md-2 col-sm-6 sm-6 col-xs-6">
                       <img className="img-fluid img-brand d-block mx-auto"
                                src={imgBanco1} alt="Tarjeta" />
                    </div>
                    <div className="col-md-2 col-sm-6 sm-6 md-2">
                    <img className="img-fluid img-brand d-block mx-auto"
                                src={imgBanco2} alt="Tarjeta" />
                    </div>
                    <div className="col-md-2 col-sm-6 my-6 xs-6">
                    <img className="img-fluid img-brand d-block mx-auto"
                                src={imgBanco3} alt="Tarjeta" />
                    </div>
                    <div className="col-md-2 col-sm-6 my-6 xs-6">
                    <img className="img-fluid img-brand d-block mx-auto"
                                src={imgBanco4} alt="Tarjeta" />
                    </div>
                    <div className="col-md-2 col-sm-6 my-6 xs-6">
                    <img className="img-fluid img-brand d-block mx-auto"
                                src={imgBanco5} alt="Tarjeta" />
                    </div>
                    <div className="col-md-2 col-sm-6 my-6 xs-6">
                    <img className="img-fluid img-brand d-block mx-auto"
                                src={imgBanco6} alt="Tarjeta" />
                </div>
                </div>
            </div>
        <div class="enviosContainer">
            <h3>3 cuotas <span>Sin interes</span> en todo el sitio </h3>
        </div>
        <div class="sliderContenedor">
            <div class="textoSlider">
